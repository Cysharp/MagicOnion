...
namespace MagicOnion.Resolvers
{
    ...
    internal static class MagicOnionResolverGetFormatterHelper
    {
        ...
        internal static object GetFormatter(Type t)
        {
            ...
            switch (key)
            {
                ...
                case 3: return new MagicOnion.Formatters.FileModeFormatter();
                case 4: return new MagicOnion.Formatters.ClientCertificateOptionFormatter();
                case 5: return new MagicOnion.Formatters.ApartmentStateFormatter();
                case 6: return new MagicOnion.Formatters.TaskCreationOptionsFormatter();
                default: return null;
            }
        }
    }
    ...
    internal static class TypeHints
    {
        ...
        {
            _ = MagicOnionResolver.Instance.GetFormatter<global::MagicOnion.DynamicArgumentTuple<global::System.Int32, global::System.Collections.Generic.IReadOnlyList<global::System.Int32>, global::System.IO.FileMode, global::System.Linq.ILookup<global::System.String, global::System.String>, global::System.Net.Http.ClientCertificateOption, global::System.Threading.ApartmentState, global::System.Threading.Tasks.TaskCreationOptions>>();
            _ = MagicOnionResolver.Instance.GetFormatter<global::MessagePack.Nil>();
            _ = MagicOnionResolver.Instance.GetFormatter<global::System.Collections.Generic.IReadOnlyList<global::System.Int32>>();
            _ = MagicOnionResolver.Instance.GetFormatter<global::System.Int32>();
            _ = MagicOnionResolver.Instance.GetFormatter<global::System.IO.FileMode>();
            _ = MagicOnionResolver.Instance.GetFormatter<global::System.Linq.ILookup<global::System.String, global::System.String>>();
            _ = MagicOnionResolver.Instance.GetFormatter<global::System.Net.Http.ClientCertificateOption>();
            _ = MagicOnionResolver.Instance.GetFormatter<global::System.String>();
            _ = MagicOnionResolver.Instance.GetFormatter<global::System.Threading.ApartmentState>();
            _ = MagicOnionResolver.Instance.GetFormatter<global::System.Threading.Tasks.TaskCreationOptions>();
        }
    }
}
