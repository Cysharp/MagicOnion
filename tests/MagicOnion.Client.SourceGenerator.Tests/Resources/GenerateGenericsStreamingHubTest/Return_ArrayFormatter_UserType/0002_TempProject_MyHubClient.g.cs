        ...
        static partial class MagicOnionGeneratedClient
        {
            ...
            public class TempProject_MyHubClient : global::MagicOnion.Client.StreamingHubClientBase<global::TempProject.IMyHub, global::TempProject.IMyHubReceiver>, global::TempProject.IMyHub
            {
                ...
                public global::System.Threading.Tasks.Task<global::TempProject.MyResponse[]> GetValuesAsync()
                    => this.WriteMessageWithResponseTaskAsync<global::MessagePack.Nil, global::TempProject.MyResponse[]>(-209315513, global::MessagePack.Nil.Default);
                ...
                class FireAndForgetClient : global::TempProject.IMyHub
                {
                    ...
                    public global::System.Threading.Tasks.Task<global::TempProject.MyResponse[]> GetValuesAsync()
                        => parent.WriteMessageFireAndForgetTaskAsync<global::MessagePack.Nil, global::TempProject.MyResponse[]>(-209315513, global::MessagePack.Nil.Default);
                ...
                protected override void OnResponseEvent(global::System.Int32 methodId, global::System.Object taskSource, global::System.ReadOnlyMemory<global::System.Byte> data)
                {
                    switch (methodId)
                    {
                        case -209315513: // Task<MyResponse[]> GetValuesAsync()
                            base.SetResultForResponse<global::TempProject.MyResponse[]>(taskSource, data);
                            break;
                    }
                }
