        ...
        static partial class MagicOnionGeneratedClient
        {
            ...
            public class TempProject_MyHubClient : global::MagicOnion.Client.StreamingHubClientBase<global::TempProject.IMyHub, global::TempProject.IMyHubReceiver>, global::TempProject.IMyHub
            {
                ...
                public global::System.Threading.Tasks.Task<global::System.Collections.Generic.List<global::TempProject.MyResponse>> GetValuesAsync()
                    => this.WriteMessageWithResponseTaskAsync<global::MessagePack.Nil, global::System.Collections.Generic.List<global::TempProject.MyResponse>>(-209315513, global::MessagePack.Nil.Default);
                ...
                class FireAndForgetClient : global::TempProject.IMyHub
                {
                    ...
                    public global::System.Threading.Tasks.Task<global::System.Collections.Generic.List<global::TempProject.MyResponse>> GetValuesAsync()
                        => parent.WriteMessageFireAndForgetTaskAsync<global::MessagePack.Nil, global::System.Collections.Generic.List<global::TempProject.MyResponse>>(-209315513, global::MessagePack.Nil.Default);
                ...
                protected override void OnResponseEvent(global::System.Int32 methodId, global::System.Object taskCompletionSource, global::System.ReadOnlyMemory<global::System.Byte> data)
                {
                    switch (methodId)
                    {
                        case -209315513: // Task<List<MyResponse>> GetValuesAsync()
                            base.SetResultForResponse<global::System.Collections.Generic.List<global::TempProject.MyResponse>>(taskCompletionSource, data);
                            break;
                    }
                }
