        ...
        static partial class MagicOnionGeneratedClient
        {
            ...
            public class TempProject_MyHubClient : global::MagicOnion.Client.StreamingHubClientBase<global::TempProject.IMyHub, global::TempProject.IMyHubReceiver>, global::TempProject.IMyHub
            {
                ...
                protected override void OnBroadcastEvent(global::System.Int32 methodId, global::System.ReadOnlyMemory<global::System.Byte> data)
                {
                    switch (methodId)
                    {
                        case -1005848884: // Void A(global::System.Collections.Generic.List<global::System.String> a)
                            {
                                var value = base.Deserialize<global::System.Collections.Generic.List<global::System.String>>(data);
                                receiver.A(value);
                            }
                            break;
                        case -955516027: // Void B(global::System.Collections.Generic.List<global::System.Int32> b)
                            {
                                var value = base.Deserialize<global::System.Collections.Generic.List<global::System.Int32>>(data);
                                receiver.B(value);
                            }
                            break;
                    }
