...
namespace TempProject
{
    ...
    public class MyHubClient : global::MagicOnion.Client.StreamingHubClientBase<global::TempProject.IMyHub, global::TempProject.IMyHubReceiver>, global::TempProject.IMyHub
    {
        ...
        protected override void OnResponseEvent(global::System.Int32 methodId, global::System.Object taskCompletionSource, global::System.ArraySegment<global::System.Byte> data)
        {
            switch (methodId)
            {
                case -1005848884: // Task<MyGenericObject<Int32>> A()
                    base.SetResultForResponse<global::TempProject.MyGenericObject<global::System.Int32>>(taskCompletionSource, data);
                    break;
                case -955516027: // Task<MyGenericObject<MyObject>> B()
                    base.SetResultForResponse<global::TempProject.MyGenericObject<global::TempProject.MyObject>>(taskCompletionSource, data);
                    break;
            }
        }
