                ...
                protected override void OnResponseEvent(global::System.Int32 methodId, global::System.Object taskSource, global::System.ReadOnlyMemory<global::System.Byte> data)
                {
                    switch (methodId)
                    {
                        case -1005848884: // Task<MyGenericObject<Int32>> A()
                            base.SetResultForResponse<global::TempProject.MyGenericObject<global::System.Int32>>(taskSource, data);
                            break;
                        case -955516027: // Task<MyGenericObject<MyObject>> B()
                            base.SetResultForResponse<global::TempProject.MyGenericObject<global::TempProject.MyObject>>(taskSource, data);
                            break;
                    }
                }
