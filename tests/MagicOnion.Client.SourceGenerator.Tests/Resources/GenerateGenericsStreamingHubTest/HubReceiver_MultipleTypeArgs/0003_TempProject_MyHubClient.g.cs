        ...
        static partial class MagicOnionGeneratedClient
        {
            ...
            public class TempProject_MyHubClient : global::MagicOnion.Client.StreamingHubClientBase<global::TempProject.IMyHub, global::TempProject.IMyHubReceiver>, global::TempProject.IMyHub
            {
                ...
                protected override void OnBroadcastEvent(global::System.Int32 methodId, global::System.ArraySegment<global::System.Byte> data)
                {
                    switch (methodId)
                    {
                        case -1005848884: // Void A(global::TempProject.MyGenericObject<global::System.Int32, global::TempProject.MyObject> a)
                            {
                                var value = base.Deserialize<global::TempProject.MyGenericObject<global::System.Int32, global::TempProject.MyObject>>(data);
                                receiver.A(value);
                            }
                            break;
                        case -955516027: // Void B(global::TempProject.MyGenericObject<global::TempProject.MyObject, global::System.Int32> b)
                            {
                                var value = base.Deserialize<global::TempProject.MyGenericObject<global::TempProject.MyObject, global::System.Int32>>(data);
                                receiver.B(value);
                            }
                            break;
                    }
