...
";
        ...
        serviceCollection.Services[0].Methods[0].ParameterTypes.Should().BeEmpty();
...
";
        ...
        serviceCollection.Services[0].Methods[0].ResponseType.Should().Be(MagicOnionTypeInfo.Create("MessagePack", "Nil"));
        serviceCollection.Services[0].Methods[0].ParameterTypes.Should().BeEquivalentTo(MagicOnionTypeInfo.Create("System", "String"));
        serviceCollection.Services[0].Methods[0].MethodReturnType.Should().Be(MagicOnionTypeInfo.Create("MagicOnion", "UnaryResult", MagicOnionTypeInfo.Create("MessagePack", "Nil")));
    }
...
";
        ...
        serviceCollection.Services[0].Methods[0].ResponseType.Should().Be(MagicOnionTypeInfo.Create("MessagePack", "Nil"));
        serviceCollection.Services[0].Methods[0].ParameterTypes.Should().BeEquivalentTo(MagicOnionTypeInfo.Create("System", "String"), MagicOnionTypeInfo.Create("System", "Int32"));
        serviceCollection.Services[0].Methods[0].MethodReturnType.Should().Be(MagicOnionTypeInfo.Create("MagicOnion", "UnaryResult", MagicOnionTypeInfo.Create("MessagePack", "Nil")));
    }
