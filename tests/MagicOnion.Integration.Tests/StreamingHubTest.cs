...
public class StreamingHubTest : IClassFixture<MagicOnionApplicationFactory<StreamingHubTestHub>>
{
    ...
    public static IEnumerable<object[]> EnumerateStreamingHubClientFactory()
    {
        ...
        {
            var client = new StreamingHubTestHubClient(callInvoker, string.Empty, new CallOptions(), messageSerializer ?? MagicOnionSerializerProvider.Default, NullMagicOnionClientLogger.Instance);
