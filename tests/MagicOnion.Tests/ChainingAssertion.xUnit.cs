...
namespace Xunit
{
    ...
    public static partial class AssertEx
    {
        ...
        public static void IsStructuralEqual(this object actual, object expected, string message = "")
        {
            ...
            if (actual == null) throw new Exception("actual is null" + message);
            if (expected == null) throw new Exception("actual is not null" + message);
        ...
        {
            message = (string.IsNullOrEmpty(message) ? "" : ", " + message);
            if (object.ReferenceEquals(actual, expected)) throw new Exception("actual is same reference" + message); ;
            ...
            if (r.IsEquals)
            {
                throw new Exception("is structural equal" + message);
            }
        }
