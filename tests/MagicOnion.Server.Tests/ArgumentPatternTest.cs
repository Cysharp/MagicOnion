...
public class ArgumentPatternTest : IClassFixture<ServerFixture<ArgumentPattern>>
{
    ...
    class ArgumentPatternManualClient : IArgumentPattern
    {
        ...
        public UnaryResult<MyResponse> Unary1(int x, int y, string z = "unknown")
        {
            ...
            var method = GrpcMethodHelper.CreateMethod<DynamicArgumentTuple<int, int>, MyResponse, Box<DynamicArgumentTuple<int, int>>, MyResponse>(MethodType.Unary, "IArgumentPattern", "Unary1", MessagePackMagicOnionSerializerProvider.Instance.Create(MethodType.Unary, null));
