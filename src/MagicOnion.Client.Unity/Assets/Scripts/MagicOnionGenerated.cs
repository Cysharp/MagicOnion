...
namespace MagicOnion
{
    ...
    public static partial class MagicOnionInitializer
    {
        ...
        public static void Register()
        {
            ...
            MagicOnionClientRegistry<Sandbox.NetCoreServer.Hubs.ITestService>.Register((x, y, z) => new Sandbox.NetCoreServer.Hubs.TestServiceClient(x, y, z));
            MagicOnionClientRegistry<Sandbox.NetCoreServer.Services.IMyFirstService>.Register((x, y, z) => new Sandbox.NetCoreServer.Services.MyFirstServiceClient(x, y, z));
            MagicOnionClientRegistry<Sandbox.NetCoreServer.Services.ICalcSerivce>.Register((x, y, z) => new Sandbox.NetCoreServer.Services.CalcSerivceClient(x, y, z));
            MagicOnionClientRegistry<MagicOnion.IService>.Register((x, y, z) => new MagicOnion.ServiceClient(x, y, z));
            ...
            StreamingHubClientRegistry<Sandbox.NetCoreServer.Hubs.IGamingHub, Sandbox.NetCoreServer.Hubs.IGamingHubReceiver>.Register((a, _, b, c, d, e) => new Sandbox.NetCoreServer.Hubs.GamingHubClient(a, b, c, d, e));
            StreamingHubClientRegistry<Sandbox.NetCoreServer.Hubs.IBugReproductionHub, Sandbox.NetCoreServer.Hubs.IBugReproductionHubReceiver>.Register((a, _, b, c, d, e) => new Sandbox.NetCoreServer.Hubs.BugReproductionHubClient(a, b, c, d, e));
            StreamingHubClientRegistry<Sandbox.NetCoreServer.Hubs.IChatHub, Sandbox.NetCoreServer.Hubs.IMessageReceiver2>.Register((a, _, b, c, d, e) => new Sandbox.NetCoreServer.Hubs.ChatHubClient(a, b, c, d, e));
            StreamingHubClientRegistry<Sandbox.NetCoreServer.Hubs.ITestHub, Sandbox.NetCoreServer.Hubs.IMessageReceiver>.Register((a, _, b, c, d, e) => new Sandbox.NetCoreServer.Hubs.TestHubClient(a, b, c, d, e));
        }
    }
}
    ...
    internal static class MagicOnionResolverGetFormatterHelper
    {
        ...
        static MagicOnionResolverGetFormatterHelper()
        {
            lookup = new global::System.Collections.Generic.Dictionary<Type, int>(12)
            {
                ...
                {typeof(global::MagicOnion.DynamicArgumentTuple<string, long>), 3 },
                {typeof(global::MagicOnion.DynamicArgumentTuple<string, string, Vector3, Quaternion>), 4 },
                {typeof(global::MagicOnion.DynamicArgumentTuple<string, string>), 5 },
                {typeof(global::MagicOnion.DynamicArgumentTuple<Vector3, Quaternion>), 6 },
        ...
        internal static object GetFormatter(Type t)
        {
            ...
            switch (key)
            {
                ...
                case 3: return new global::MagicOnion.DynamicArgumentTupleFormatter<string, long>(default(string), default(long));
                case 4: return new global::MagicOnion.DynamicArgumentTupleFormatter<string, string, Vector3, Quaternion>(default(string), default(string), default(Vector3), default(Quaternion));
                case 5: return new global::MagicOnion.DynamicArgumentTupleFormatter<string, string>(default(string), default(string));
                case 6: return new global::MagicOnion.DynamicArgumentTupleFormatter<Vector3, Quaternion>(default(Vector3), default(Quaternion));
...
namespace MagicOnion {
    ...
    [Ignore]
    public class ServiceClient : MagicOnionClientBase<global::MagicOnion.IService<TSelf>>, global::MagicOnion.IService<TSelf>
    {
        static readonly Method<byte[], byte[]> WithOptionsMethod;
        static readonly Method<byte[], byte[]> WithHeadersMethod;
        static readonly Method<byte[], byte[]> WithDeadlineMethod;
        static readonly Method<byte[], byte[]> WithCancellationTokenMethod;
        static readonly Method<byte[], byte[]> WithHostMethod;

        static ServiceClient()
        {
            WithOptionsMethod = new Method<byte[], byte[]>(MethodType.Other, "IService", "WithOptions", MagicOnionMarshallers.ThroughMarshaller, MagicOnionMarshallers.ThroughMarshaller);
            WithHeadersMethod = new Method<byte[], byte[]>(MethodType.Other, "IService", "WithHeaders", MagicOnionMarshallers.ThroughMarshaller, MagicOnionMarshallers.ThroughMarshaller);
            WithDeadlineMethod = new Method<byte[], byte[]>(MethodType.Other, "IService", "WithDeadline", MagicOnionMarshallers.ThroughMarshaller, MagicOnionMarshallers.ThroughMarshaller);
            WithCancellationTokenMethod = new Method<byte[], byte[]>(MethodType.Other, "IService", "WithCancellationToken", MagicOnionMarshallers.ThroughMarshaller, MagicOnionMarshallers.ThroughMarshaller);
            WithHostMethod = new Method<byte[], byte[]>(MethodType.Other, "IService", "WithHost", MagicOnionMarshallers.ThroughMarshaller, MagicOnionMarshallers.ThroughMarshaller);
        }
        ...
        public ServiceClient(CallInvoker callInvoker, IFormatterResolver resolver, IClientFilter[] filters)
            : base(callInvoker, resolver, filters)
        {
        }

        protected override MagicOnionClientBase<IService> Clone()
        {
            var clone = new ServiceClient();
        ...
        public new IService WithHeaders(Metadata headers)
        {
            return base.WithHeaders(headers);
        }

        public new IService WithCancellationToken(System.Threading.CancellationToken cancellationToken)
        {
            return base.WithCancellationToken(cancellationToken);
        }

        public new IService WithDeadline(System.DateTime deadline)
        {
            return base.WithDeadline(deadline);
        }

        public new IService WithHost(string host)
        {
            return base.WithHost(host);
        }

        public new IService WithOptions(CallOptions option)
        {
            return base.WithOptions(option);
        }
   

        public TSelf WithOptions(CallOptions option)
        {
        }

        public TSelf WithHeaders(Metadata headers)
        {
        }

        public TSelf WithDeadline(global::System.DateTime deadline)
        {
        }

        public TSelf WithCancellationToken(global::System.Threading.CancellationToken cancellationToken)
        {
        }

        public TSelf WithHost(string host)
        {
        }
    }
}
...
namespace MagicOnion.Server.EmbeddedServices {
    ...
    public class MagicOnionEmbeddedHeartbeatClient : MagicOnionClientBase<global::MagicOnion.Server.EmbeddedServices.IMagicOnionEmbeddedHeartbeat>, global::MagicOnion.Server.EmbeddedServices.IMagicOnionEmbeddedHeartbeat
    {
        ...
        public MagicOnionEmbeddedHeartbeatClient(CallInvoker callInvoker, IFormatterResolver resolver, IClientFilter[] filters)
            : base(callInvoker, resolver, filters)
        {
        }
        ...
        public global::System.Threading.Tasks.Task<global::MagicOnion.DuplexStreamingResult<global::MessagePack.Nil, global::MessagePack.Nil>> Connect()
        {
            ...
            return System.Threading.Tasks.Task.FromResult(new DuplexStreamingResult<global::MessagePack.Nil, global::MessagePack.Nil>(__callResult, base.resolver));
        }
    }
    ...
    public class MagicOnionEmbeddedPingClient : MagicOnionClientBase<global::MagicOnion.Server.EmbeddedServices.IMagicOnionEmbeddedPing>, global::MagicOnion.Server.EmbeddedServices.IMagicOnionEmbeddedPing
    {
        ...
        public MagicOnionEmbeddedPingClient(CallInvoker callInvoker, IFormatterResolver resolver, IClientFilter[] filters)
            : base(callInvoker, resolver, filters)
        {
        }
...
namespace Sandbox.NetCoreServer.Hubs {
    ...
    public class TestServiceClient : MagicOnionClientBase<global::Sandbox.NetCoreServer.Hubs.ITestService>, global::Sandbox.NetCoreServer.Hubs.ITestService
    {
        ...
        public TestServiceClient(CallInvoker callInvoker, IFormatterResolver resolver, IClientFilter[] filters)
            : base(callInvoker, resolver, filters)
        {
        }
        ...
        {
            var clone = new TestServiceClient();
            clone.host = this.host;
            clone.option = this.option;
            clone.callInvoker = this.callInvoker;
            clone.resolver = this.resolver;
...
namespace Sandbox.NetCoreServer.Services {
    ...
    public class MyFirstServiceClient : MagicOnionClientBase<global::Sandbox.NetCoreServer.Services.IMyFirstService>, global::Sandbox.NetCoreServer.Services.IMyFirstService
    {
        ...
        public MyFirstServiceClient(CallInvoker callInvoker, IFormatterResolver resolver, IClientFilter[] filters)
            : base(callInvoker, resolver, filters)
        {
        }
    ...
    [Ignore]
    public class CalcSerivceClient : MagicOnionClientBase<global::Sandbox.NetCoreServer.Services.ICalcSerivce>, global::Sandbox.NetCoreServer.Services.ICalcSerivce
    {
        static readonly Method<byte[], byte[]> DumpAsyncMethod;
        static readonly Func<RequestContext, ResponseContext> DumpAsyncDelegate;
        static readonly Method<byte[], byte[]> Dump1AsyncMethod;
        static readonly Func<RequestContext, ResponseContext> Dump1AsyncDelegate;
        static readonly Method<byte[], byte[]> Dump2AsyncMethod;
        static readonly Func<RequestContext, ResponseContext> Dump2AsyncDelegate;
        static readonly Method<byte[], byte[]> SumAsyncMethod;
        static readonly Func<RequestContext, ResponseContext> SumAsyncDelegate;

        static CalcSerivceClient()
        {
            DumpAsyncMethod = new Method<byte[], byte[]>(MethodType.Unary, "ICalcSerivce", "DumpAsync", MagicOnionMarshallers.ThroughMarshaller, MagicOnionMarshallers.ThroughMarshaller);
            DumpAsyncDelegate = _DumpAsync;
            Dump1AsyncMethod = new Method<byte[], byte[]>(MethodType.Unary, "ICalcSerivce", "Dump1Async", MagicOnionMarshallers.ThroughMarshaller, MagicOnionMarshallers.ThroughMarshaller);
            Dump1AsyncDelegate = _Dump1Async;
            Dump2AsyncMethod = new Method<byte[], byte[]>(MethodType.Unary, "ICalcSerivce", "Dump2Async", MagicOnionMarshallers.ThroughMarshaller, MagicOnionMarshallers.ThroughMarshaller);
            Dump2AsyncDelegate = _Dump2Async;
            SumAsyncMethod = new Method<byte[], byte[]>(MethodType.Unary, "ICalcSerivce", "SumAsync", MagicOnionMarshallers.ThroughMarshaller, MagicOnionMarshallers.ThroughMarshaller);
            SumAsyncDelegate = _SumAsync;
        }
        ...
        public CalcSerivceClient(CallInvoker callInvoker, IFormatterResolver resolver, IClientFilter[] filters)
            : base(callInvoker, resolver, filters)
        {
        }

        protected override MagicOnionClientBase<ICalcSerivce> Clone()
        {
            var clone = new CalcSerivceClient();
            clone.host = this.host;
            clone.option = this.option;
            clone.callInvoker = this.callInvoker;
            clone.resolver = this.resolver;
        ...
        public new ICalcSerivce WithHeaders(Metadata headers)
        {
            return base.WithHeaders(headers);
        }

        public new ICalcSerivce WithCancellationToken(System.Threading.CancellationToken cancellationToken)
        {
            return base.WithCancellationToken(cancellationToken);
        }

        public new ICalcSerivce WithDeadline(System.DateTime deadline)
        {
            return base.WithDeadline(deadline);
        }

        public new ICalcSerivce WithHost(string host)
        {
            return base.WithHost(host);
        }

        public new ICalcSerivce WithOptions(CallOptions option)
        {
            return base.WithOptions(option);
        }
   
        static ResponseContext _DumpAsync(RequestContext __context)
        {
            return CreateResponseContext<int, string>(__context, DumpAsyncMethod);
        }

        public global::MagicOnion.UnaryResult<string> DumpAsync(int x)
        {
            return InvokeAsync<int, string>("ICalcSerivce/DumpAsync", x, DumpAsyncDelegate);
        }
        static ResponseContext _Dump1Async(RequestContext __context)
        {
            return CreateResponseContext<DynamicArgumentTuple<int, int>, string>(__context, Dump1AsyncMethod);
        }

        public global::MagicOnion.UnaryResult<string> Dump1Async(int x, int y)
        {
            return InvokeAsync<DynamicArgumentTuple<int, int>, string>("ICalcSerivce/Dump1Async", new DynamicArgumentTuple<int, int>(x, y), Dump1AsyncDelegate);
        }
        static ResponseContext _Dump2Async(RequestContext __context)
        {
            return CreateResponseContext<DynamicArgumentTuple<int, int>, string>(__context, Dump2AsyncMethod);
        }

        public global::MagicOnion.UnaryResult<string> Dump2Async(int x, int y)
        {
            return InvokeAsync<DynamicArgumentTuple<int, int>, string>("ICalcSerivce/Dump2Async", new DynamicArgumentTuple<int, int>(x, y), Dump2AsyncDelegate);
        }
        static ResponseContext _SumAsync(RequestContext __context)
        {
            return CreateResponseContext<DynamicArgumentTuple<int, int>, string>(__context, SumAsyncMethod);
        ...
        public global::MagicOnion.UnaryResult<string> SumAsync(int x, int y)
        {
            return InvokeAsync<DynamicArgumentTuple<int, int>, string>("ICalcSerivce/SumAsync", new DynamicArgumentTuple<int, int>(x, y), SumAsyncDelegate);
        }
    }
}
...
namespace Sandbox.NetCoreServer.Hubs {
    ...
    public class GamingHubClient : StreamingHubClientBase<global::Sandbox.NetCoreServer.Hubs.IGamingHub, global::Sandbox.NetCoreServer.Hubs.IGamingHubReceiver>, global::Sandbox.NetCoreServer.Hubs.IGamingHub
    {
        ...
        public GamingHubClient(CallInvoker callInvoker, string host, CallOptions option, IFormatterResolver resolver, ILogger logger)
        ...
        public global::System.Threading.Tasks.Task<global::Sandbox.NetCoreServer.Hubs.Player[]> JoinAsync(string roomName, string userName, Vector3 position, Quaternion rotation)
        {
            return WriteMessageWithResponseAsync<DynamicArgumentTuple<string, string, Vector3, Quaternion>, global::Sandbox.NetCoreServer.Hubs.Player[]> (-733403293, new DynamicArgumentTuple<string, string, Vector3, Quaternion>(roomName, userName, position, rotation));
        }
        ...
        public global::System.Threading.Tasks.Task MoveAsync(Vector3 position, Quaternion rotation)
        {
            return WriteMessageWithResponseAsync<DynamicArgumentTuple<Vector3, Quaternion>, Nil>(-99261176, new DynamicArgumentTuple<Vector3, Quaternion>(position, rotation));
        }
        ...
        class FireAndForgetClient : global::Sandbox.NetCoreServer.Hubs.IGamingHub
        {
            ...
            public global::System.Threading.Tasks.Task<global::Sandbox.NetCoreServer.Hubs.Player[]> JoinAsync(string roomName, string userName, Vector3 position, Quaternion rotation)
            {
                return __parent.WriteMessageAsyncFireAndForget<DynamicArgumentTuple<string, string, Vector3, Quaternion>, global::Sandbox.NetCoreServer.Hubs.Player[]> (-733403293, new DynamicArgumentTuple<string, string, Vector3, Quaternion>(roomName, userName, position, rotation));
            }
            ...
            public global::System.Threading.Tasks.Task MoveAsync(Vector3 position, Quaternion rotation)
            {
                return __parent.WriteMessageAsync<DynamicArgumentTuple<Vector3, Quaternion>>(-99261176, new DynamicArgumentTuple<Vector3, Quaternion>(position, rotation));
            }
    ...
    public class BugReproductionHubClient : StreamingHubClientBase<global::Sandbox.NetCoreServer.Hubs.IBugReproductionHub, global::Sandbox.NetCoreServer.Hubs.IBugReproductionHubReceiver>, global::Sandbox.NetCoreServer.Hubs.IBugReproductionHub
    {
        ...
        public BugReproductionHubClient(CallInvoker callInvoker, string host, CallOptions option, IFormatterResolver resolver, ILogger logger)
            : base(callInvoker, host, option, resolver, logger)
        {
            this.__fireAndForgetClient = new FireAndForgetClient(this);
        }
        ...
        class FireAndForgetClient : global::Sandbox.NetCoreServer.Hubs.IBugReproductionHub
        {
            ...
            public FireAndForgetClient(BugReproductionHubClient parentClient)
            {
                this.__parent = parentClient;
            }
    ...
    public class TestHubClient : StreamingHubClientBase<global::Sandbox.NetCoreServer.Hubs.ITestHub, global::Sandbox.NetCoreServer.Hubs.IMessageReceiver>, global::Sandbox.NetCoreServer.Hubs.ITestHub
    {
        ...
        public TestHubClient(CallInvoker callInvoker, string host, CallOptions option, IFormatterResolver resolver, ILogger logger)
            : base(callInvoker, host, option, resolver, logger)
        {
            this.__fireAndForgetClient = new FireAndForgetClient(this);
        }
        ...
        class FireAndForgetClient : global::Sandbox.NetCoreServer.Hubs.ITestHub
        {
            ...
            public FireAndForgetClient(TestHubClient parentClient)
            {
                this.__parent = parentClient;
            }
