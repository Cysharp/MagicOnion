    ...
    where TService : class
{
        ...
        where TRawResponse : class
    {
        ...
        providerContext.AddServerStreamingMethod<TRawRequest, TRawResponse>(grpcMethod, attrs, handlerBuilder.BuildServerStreamingMethod(method, messageSerializer, attrs));
    }
