...
public partial class MagicOnionClientSourceGenerator
{
    ...
    static IReadOnlyList<(string Path, string Source)> Emit(GenerationContext context, MagicOnionServiceCollection serviceCollection, CancellationToken cancellationToken)
    {
    ...
    static void Emit(GenerationContext context, ImmutableArray<INamedTypeSymbol> interfaceSymbols, ReferenceSymbols referenceSymbols)
    {
        ...
        var generated = Emit(context, serviceCollection, context.SourceProductionContext.CancellationToken);
