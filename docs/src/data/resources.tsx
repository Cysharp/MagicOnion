...
const Slides: Resource[] = [
    {
        type: 'slide',
        locale: 'ja',
        title: '全世界リリースを支えるマルチプレイゲームの裏側【CAGC2024】※2025年3月6日までの公開',
        url: 'https://speakerdeck.com/cyberagentdevelopers/quan-shi-jie-ririsuwozhi-erumarutipureigemunoli-ce-cagc2024-star-2025nian-3yue-6ri-madenogong-kai',
        description: 'CyberAgent Game Conference 2024',
        year: 2024,
        month: 3,
    },
    {
