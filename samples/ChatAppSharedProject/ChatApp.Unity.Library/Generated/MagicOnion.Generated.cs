...
namespace MagicOnion
{
    ...
    public static partial class MagicOnionInitializer
    {
        ...
        public static void Register()
        {
            ...
            MagicOnionClientRegistry<ChatApp.Shared.IChatService>.Register((x, y) => new ChatApp.Shared.IChatServiceClient(x, y));

            StreamingHubClientRegistry<ChatApp.Shared.IChatHub, ChatApp.Shared.IChatHubReceiver>.Register((a, _, b, c, d, e) => new ChatApp.Shared.IChatHubClient(a, b, c, d, e));
        }
    }
}
...
namespace ChatApp.Shared {
    ...
    public class IChatServiceClient : MagicOnionClientBase<global::ChatApp.Shared.IChatService>, global::ChatApp.Shared.IChatService
    {
...
namespace ChatApp.Shared {
    ...
    public class IChatHubClient : StreamingHubClientBase<global::ChatApp.Shared.IChatHub, global::ChatApp.Shared.IChatHubReceiver>, global::ChatApp.Shared.IChatHub
    {
        ...
        readonly global::ChatApp.Shared.IChatHub __fireAndForgetClient;
        ...
        public global::ChatApp.Shared.IChatHub FireAndForget()
        {
        ...
        protected override Task OnBroadcastEvent(int methodId, ArraySegment<byte> data)
        {
            switch (methodId)
            {
                ...
                {
                    var result = LZ4MessagePackSerializer.Deserialize<global::ChatApp.Shared.MessageResponse>(data, resolver);
        ...
        public global::System.Threading.Tasks.Task JoinAsync(global::ChatApp.Shared.JoinRequest request)
        {
            return WriteMessageWithResponseAsync<global::ChatApp.Shared.JoinRequest, Nil>(-733403293, request);
        }
        ...
        class FireAndForgetClient : global::ChatApp.Shared.IChatHub
        {
            ...
            public global::System.Threading.Tasks.Task JoinAsync(global::ChatApp.Shared.JoinRequest request)
            {
                return __parent.WriteMessageAsync<global::ChatApp.Shared.JoinRequest>(-733403293, request);
            }
